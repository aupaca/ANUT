...
void VertexArray::addVertexBuffer(const GpuBuffer& vb, unsigned attribIndex, int subAttribCount, GLenum subAttribType, bool normalized, int stride, int offset)
{
...
void VertexArray::setIndexBuffer(const GpuBuffer& eb)
{
